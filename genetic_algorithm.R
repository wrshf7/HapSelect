...
haploblock_effects = haploblock_effects[1:15, ]
...
GA_output = genetic_algorithm(localGEBV = localGEBV, n_founders = 25, popSize = 200, maxiter = 300, run = 150, selfing = TRUE, pmutation = 0.2, pcrossover = 0.8)

####main function####
genetic_algorithm = function(localGEBV, n_founders = 20, popSize = 100, maxiter = 500, run = 50, selfing = FALSE, pmutation = 0.1, pcrossover = 0.8){
